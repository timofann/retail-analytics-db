...
1.  **Формирование списков карт.** Для каждого клиента формируется
    ...
    `Customer_Card_ID` таблицы [Персональные данные](../README.md#таблица-персональные-данные).
...
5.  **Определение интенсивности транзакций.** Для каждого клиента
    ...
    `Transaction_Date` таблицы [Транзакции](../README.md#таблица-транзакции). Полученное значение
...
8.  **Определение периода после предыдущей транзакции.** Для каждого
    ...
    клиента. Данные берутся из поля `Transaction_Date` таблицы [Транзакции](../README.md#таблица-транзакции) по всем картам клиента.
...
14. **Определение магазина, в котором клиент совершил три предыдущие
    ...
    полях `Transaction_Store_ID` и `Transaction_Date`.
